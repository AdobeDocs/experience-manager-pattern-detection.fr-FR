...
>abstract="Le réseau de diffusion de contenu identifie les widgets de boîte de dialogue personnalisés à mettre à jour pour qu’ils soient compatibles avec AEM as a Cloud Service."

`CDW`  (`Custom Dialog Widgets`) Identifie les widgets de boîte de dialogue classiques personnalisés. Ces widgets doivent être mis à jour pour être compatibles avec AEM as a Cloud Service.
