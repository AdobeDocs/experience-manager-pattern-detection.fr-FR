...
* Ne modifiez pas et ne supprimez pas les quatre configurations mentionnées ci-dessus.
   * En cas de violation suivante :\
      ...
      Vérifiez si ces suppressions sont légales ou non, car ces configurations OSGI sont prêtes à l’emploi et peuvent ne jamais avoir été modifiées/enregistrées à partir du gestionnaire de configuration OSGi.
