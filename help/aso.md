...
* La version d’AEM, le nombre de nœuds, l’appartenance à un groupe et les types d’implémentation du magasin de nœuds et de l’entrepôt de données sont fournis à titre informatif.
